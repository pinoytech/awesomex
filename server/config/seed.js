...
Week.find({}).remove(function() {
  var week = new Week({name: 3, quota: 0});
  week.save();
  Task.find({}).remove(function() {
    var task = new Task({
      point: 2,
...
Week.find({}).remove(function() {
  var week = new Week({name: 4, quota: 0});
  week.save();
  Task.find({}).remove(function() {
    var task = new Task({
      point: 2,
...
Week.find({}).remove(function() {
  var week = new Week({name: 5, quota: 0});
  week.save();
  Task.find({}).remove(function() {
    var task = new Task({
      week_id: 5,
...
Week.find({}).remove(function() {
  var week = new Week({name: 6, quota: 0});
  week.save();
  Task.find({}).remove(function() {
    var task = new Task({
      week_id: 6,
...
Week.find({}).remove(function() {
  var week = new Week({name: 7, quota: 0});
  week.save();
  Task.find({}).remove(function() {
    var task = new Task({
      week_id: 7,
